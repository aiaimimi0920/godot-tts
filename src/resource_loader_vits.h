#ifndef RESOURCE_LOADER_VITS_H
#define RESOURCE_LOADER_VITS_H
...
class ResourceFormatLoaderVITS : public ResourceFormatLoader {
	GDCLASS(ResourceFormatLoaderVITS, ResourceFormatLoader);
